...
def write_tvshow_nfo(
    ...
    series_dir = os.path.join(settings.DOWNLOAD_DIR, safe_name)
    ...
    SubElement(root, "plot").text = description or f"YouTube channel: {channel_name}"
    SubElement(root, "genre").text = "YouTube"
