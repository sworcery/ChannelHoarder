...
export const api = {
  ...
  addChannel: (data: { url: string; quality?: string; download_dir?: string; auto_download?: boolean; title_filter?: string; title_filter_is_regex?: boolean; title_filter_mode?: string }) =>
